/*
  # Fix database schema and storage policies

  1. Changes
    - Drop and recreate bots table with correct schema
    - Add proper timestamps and triggers
    - Set up RLS policies for anonymous access
    - Create storage bucket and policies
    - Add trigger for updated_at timestamp

  2. Security
    - Enable RLS on bots table and storage
